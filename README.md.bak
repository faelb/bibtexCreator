...
-> to use this little program first install pyperclip3:
...
So with this small programm you just copy paste the stuff from the internet article the program asks for, and at the end it will create you a bibtex string and put it into your clipboard (Ctrl+V to paste it) to just add to your reference program.
